(function(){
	...
	app.controller('myCtrl', ['$scope', '$filter', '$http',  function ($scope, $filter, $http) {
		...
		$scope.rowSizeList = [
	        { id: 1, value: 5, name: "5 Rows" },
	        { id: 2, value: 10, name: "10 Rows" },
	        { id: 3, value: 20, name: "20 Rows" },
	        { id: 4, value: 25, name: "25 Rows" },
	        { id: 5, value: 50, name: "50 Rows" },
	        { id: 6, value: 10, name: "100 Rows" },
	        { id: 7, value: 15, name: "150 Rows" }
	    ];
